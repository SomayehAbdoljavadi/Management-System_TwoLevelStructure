...
exports.SamadService = (request, res,self) => {
    return new Promise(function (resolve, reject) {
        console.log("self**SamadService",self);
...
exports.SamadServiceRollBack = (request, response,self) => {
    console.log("self**SamadServiceRollBack",self);
